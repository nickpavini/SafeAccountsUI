...
import { AttempRefresh, DeleteMultipleItems, CloseSelectedItemsMenu } from '../../../HelperFunctions.js'
...
export class SelectedItemsMenu extends Component {
    ...
    render() {
        ...
        // menu options
            ...
            return (
                <div id="menu_selected_items" >
                    <div className="menu_selected_items" id="menu_selected_items_delete" onClick={() => DeleteMultipleItems(this.props.AppState, this.props.SetAppState)}>Delete Items</div>
